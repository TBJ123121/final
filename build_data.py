...
tf.flags.DEFINE_string('X_input_dir', 'data/face2icon/face/',
                       'X input directory, default: data/apple2orange/')   #資料及1
tf.flags.DEFINE_string('Y_input_dir', 'data/face2icon/iconography/',
                       'Y input directory, default: data/apple2orange/')   #資料及2
tf.flags.DEFINE_string('X_output_file', 'data/face2icon/face.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/apple.tfrecords')
tf.flags.DEFINE_string('Y_output_file', 'data/face2icon/icon.tfrecords',
