...
tf.flags.DEFINE_string('checkpoint_dir', 'checkpoints/20210102-0311/', 'checkpoints/20210102-0311/')
tf.flags.DEFINE_string('XtoY_model', 'cmy2lkcv2.pb', 'XtoY model name, default: horse2zebra.pb')
tf.flags.DEFINE_string('YtoX_model', 'lkc2cmyv2.pb', 'YtoX model name, default: zebra2horse.pb')
